...
HD_PWD='C:/digital_circuit_idc/rc_car_final_2/rc_car_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rc_car.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_rc_car.tcl -notrace
