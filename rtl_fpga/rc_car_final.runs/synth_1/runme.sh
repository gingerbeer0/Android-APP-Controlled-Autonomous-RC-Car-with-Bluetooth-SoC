...
HD_PWD='C:/digital_circuit_idc/rc_car_final_2/rc_car_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rc_car.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rc_car.tcl
